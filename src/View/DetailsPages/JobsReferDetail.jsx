...
import circum_share1 from "../../Images/circum_share1.png";
import phdot_three_vertical from "../../Images//phdot_three_vertical.png";
import profilephoto2 from "../../Images//profilephoto2.png";
import profilephoto3 from "../../Images//profilephoto3.png";
import profilephoto4 from "../../Images//profilephoto4.png";
...
export default function JobsReferDetail() {
  ...
  return (
    <section className="bulleDetail">
            ...
            <section id="jobs_referred">
              ...
              <div className="bottom_area_details">
                ...
                {jobs?.length > 0 ? (
                  jobs?.map((item, index) => {
                    return (
                      <div className="main mainjobsreferred">
                        <div
                          style={{
                        ...
                        >
                          <div className="top">
                            <div className="head">
                              <h4 style={{fontSize:"16px",fontWeight:600,lineHeight:"18px"}}>{item.name}</h4>
                            </div>
      ...
      {
        modalB && (<EditJobRefferedModal closemodal={setModalB}
          activity={"editJob"}
          initialValues={jobrefferedData} />)
      }

      {hiringviewmodal && <HiringDetailsModal closemodal={setHirringviewmodal} jobrefferedData={jobrefferedData} />}
    </section>
  );
}
